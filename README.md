...
Welcome to my professional portfolio. These implementations, simulations, and operational environments showcase applied experience across cybersecurity, IT support, identity security, cloud administration, and SOC monitoring.

Each entry demonstrates real-world problem-solving, technical proficiency, and operational workflows commonly found in enterprise and client-facing environments.

This portfolio reflects practical experience across system administration, security monitoring, identity governance, and infrastructure troubleshooting while emphasizing security-first design and operational reliability.
...
Designed and implemented an enterprise-style identity architecture using Microsoft Entra to demonstrate secure access governance, role-based access control, identity lifecycle management, and Zero Trust security design.
...
Linux System Hardening with Technical Brief

Applied security hardening practices including disabling unnecessary services, enforcing configuration controls, and documenting operational impact and security improvements.

Linux User Management CLI Tool

Developed a command-line utility to streamline Linux user and group administration tasks, improving operational efficiency for system administrators.
...
DNS, SSL, and Subdomain Troubleshooting
...
Performed a full network device inventory, service analysis, and port scanning to identify potential attack surfaces and strengthen the security posture of a residential network environment.

Smart Thermostat Firmware Vulnerability Simulation
...
Winlogbeat & ELK Stack Log Aggregation

Configured centralized log collection using Winlogbeat and the ELK stack, enabling SOC-style monitoring and event visualization across system endpoints.

Windows Endpoint Security Monitoring with Sysmon and ELK
...
Technical Security Briefs
Operational Documentation
Remediation Guidance

Portfolio Philosophy

This portfolio demonstrates applied technical capabilities through operational environments and real-world security scenarios.

Each implementation highlights practical problem-solving, infrastructure troubleshooting, identity governance, and security-focused decision-making. The goal is to present technical experience in a way that reflects real operational responsibilities within cybersecurity and IT environments rather than purely academic exercises.
